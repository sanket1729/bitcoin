...
class BIP68Test(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Generate some coins
        self.nodes[0].generatetoaddress(110, self.nodes[0].get_deterministic_priv_key().address)
    ...
    def activateCSV(self):
        ...
        self.nodes[0].generatetoaddress(min_activation_height - height - 2, self.nodes[0].get_deterministic_priv_key().address)
