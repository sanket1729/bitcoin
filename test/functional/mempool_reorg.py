...
class MempoolCoinbaseTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        new_blocks = self.nodes[1].generatetoaddress(4, self.nodes[1].get_deterministic_priv_key().address)
        self.sync_all()
        ...
        last_block = self.nodes[0].generatetoaddress(1, self.nodes[0].get_deterministic_priv_key().address)
