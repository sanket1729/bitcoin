...
class BIP68_112_113Test(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.coinbase_blocks = self.nodes[0].generatetoaddress(1 + 16 + 2 * 32 + 1, self.nodes[0].get_deterministic_priv_key().address)  # 82 blocks generated for inputs
        ...
        inputblockhash = self.nodes[0].generatetoaddress(1, self.nodes[0].get_deterministic_priv_key().address)[0]  # 1 block generated for inputs to be in chain at height 572
